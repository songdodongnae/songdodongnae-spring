...
public class DeliciousSpotController {
    ...
    @GetMapping
    public ResponseEntity<ResponseContainer<List<DeliciousSpotResDto>>> getAllDeliciousSpots() {
        List<DeliciousSpotResDto> deliciousSpots = deliciousSpotService.getAllDeliciousSpots();
