...
public class MyPageController {
    ...
    public ResponseEntity<ResponseContainer<List<ThumbnailResDto>>> getPostByType(
        ...
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        Long userId = Long.parseLong(authentication.getName());
        List<ThumbnailResDto> dto = myPageService.getPostByType(userId, bookmarkType, currentPage, pageSize);
